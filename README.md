...
2. В консольной команде набрать код **git clone ссылка_на_проект_в_github** (пример ссылки: https://github.com/имя_пользователя_или_организации/имя_проекта.git; git@github.com:имя_пользователя_или_организации/имя_проекта.git). Ошибка при копировании - читаем ниже блок с "Заметки"
